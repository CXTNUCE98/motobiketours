...
<template>
    <div class="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
        ...
        <!-- Duration Filter -->
        <div class="mb-6">
            <label class="block text-sm font-semibold text-gray-700 mb-3">Thời gian</label>
            <div class="space-y-2">
        ...
        <!-- Tour Type Filter -->
        <div class="mb-6">
            <label class="block text-sm font-semibold text-gray-700 mb-3">Loại tour</label>
            <div class="space-y-2">
                <label v-for="option in tourTypeOptions" :key="option.value"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer transition-all duration-300 hover:bg-gray-50">
        ...
        <!-- Depart From Filter -->
        <div class="mb-6">
            <label class="block text-sm font-semibold text-gray-700 mb-3">Khởi hành từ</label>
            <select v-model="selectedDepartFrom"
                class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-300 text-sm font-medium text-gray-700 cursor-pointer">
        ...
        <div class="space-y-3">
            ...
            <button @click="clearFilters"
                class="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
