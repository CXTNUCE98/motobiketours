...
<template>
    <div v-if="service" class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/20 to-purple-50/20">
                ...
                <div class="container mx-auto px-4 pb-12">
                    <div class="max-w-4xl">
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            <div class="px-4 py-2 rounded-xl bg-gradient-to-r from-pink-500 to-purple-600 text-white font-bold shadow-lg">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="p-8">
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                            <div v-for="(highlight, idx) in service.highlights" :key="idx"
                                                class="flex items-start gap-3 p-3 rounded-xl bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-100">
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-2">
                                            <div v-for="(item, idx) in service.included" :key="idx"
                                                class="flex items-start gap-3 p-3 rounded-xl hover:bg-green-50 transition-colors duration-200">
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-2">
                                            <div v-for="(item, idx) in service.notIncluded" :key="idx"
                                                class="flex items-start gap-3 p-3 rounded-xl hover:bg-red-50 transition-colors duration-200">
                                ...
                                <div v-if="activeTab === 'reviews'" class="space-y-6">
                                    <div v-for="review in service.reviews" :key="review.id"
                                        class="p-6 rounded-2xl bg-gradient-to-br from-gray-50 to-blue-50 border border-gray-200">
                                        <div class="flex items-start gap-4">
                                            <img :src="review.avatar" :alt="review.name"
                                                class="w-14 h-14 rounded-full border-4 border-white shadow-lg" />
                                            <div class="flex-1">
                                    ...
                                    <!-- Add Review CTA -->
                                    <div class="text-center p-8 rounded-2xl bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-dashed border-blue-300">
                                        <i class="bx bx-message-square-add text-5xl text-blue-600 mb-4"></i>
                                        <h4 class="text-xl font-bold text-gray-800 mb-2">Bạn đã sử dụng dịch vụ này?</h4>
                                        <p class="text-gray-600 mb-4">Chia sẻ trải nghiệm của bạn để giúp người khác!</p>
                                        <button class="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-bold hover:scale-105 transition-transform duration-300 shadow-lg">
                                            Viết Đánh Giá
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="lg:col-span-1">
                        ...
                        <div class="bg-white rounded-2xl shadow-xl p-6 sticky top-6">
                            <h3 class="text-2xl font-bold text-gray-800 mb-6 text-center">Liên Hệ Ngay</h3>
                            
                            <!-- Price -->
                            <div class="text-center mb-6 p-4 rounded-xl bg-gradient-to-r from-pink-50 to-purple-50 border border-pink-200">
                                <div class="text-sm text-gray-600 mb-1">Giá từ</div>
                            ...
                            <div class="border-t border-gray-200 pt-6">
                                <h4 class="font-bold text-gray-800 mb-4 flex items-center gap-2">
                                    <i class="bx bx-list-check text-blue-600"></i>
                                    Tính Năng Nổi Bật
                                </h4>
                                <div class="space-y-3">
                            ...
                            <div class="border-t border-gray-200 pt-6 mt-6">
                                <div class="grid grid-cols-3 gap-3 text-center">
                                    <div>
                                        ...
                                        <div class="text-xs text-gray-600">Bảo hiểm</div>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <div class="text-xs text-gray-600">Uy tín</div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Related Services -->
        <div class="bg-gradient-to-r from-gray-100 to-blue-100 py-16">
            <div class="container mx-auto px-4">
                <h2 class="text-3xl font-bold text-center text-gray-800 mb-12">Dịch Vụ Khác</h2>
                    ...
                    <NuxtLink v-for="relatedService in services.filter(s => s.id !== service.id).slice(0, 3)"
                        ...
                        <div class="relative h-48 overflow-hidden">
                            ...
                            <div class="absolute bottom-4 left-4 right-4">
                                <h3 class="text-white font-bold text-lg line-clamp-2">{{ relatedService.shortTitle }}</h3>
                            </div>
                        </div>
                        <div class="p-4">
                            <div class="text-sm text-gray-600 mb-2">{{ relatedService.duration }}</div>
                            <div class="font-bold text-purple-600">{{ relatedService.priceRange }}</div>
                        </div>
                    </NuxtLink>
                </div>
            </div>
    ...
    <div v-else class="min-h-screen flex items-center justify-center bg-gray-50">
        <div class="text-center">
            ...
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Không Tìm Thấy Dịch Vụ</h1>
            <p class="text-gray-600 mb-6">Dịch vụ bạn tìm kiếm không tồn tại</p>
            <NuxtLink to="/service"
