...
<template>
  <div class="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
    ...
    <div class="relative py-20 md:py-28 overflow-hidden">
      <!-- Background -->
      <div class="absolute inset-0 bg-gradient-to-br from-slate-900 via-amber-950 to-orange-950">
        <!-- Subtle geometric pattern -->
        <div class="absolute inset-0 opacity-[0.03]"
          style="background-image: url('data:image/svg+xml,%3Csvg width=&quot;60&quot; height=&quot;60&quot; viewBox=&quot;0 0 60 60&quot; xmlns=&quot;http://www.w3.org/2000/svg&quot;%3E%3Cg fill=&quot;none&quot; fill-rule=&quot;evenodd&quot;%3E%3Cg fill=&quot;%23ffffff&quot; fill-opacity=&quot;1&quot;%3E%3Cpath d=&quot;M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z&quot;/%3E%3C/g%3E%3C/g%3E%3C/svg%3E');"></div>
        <!-- Soft glow accents -->
        <div class="absolute top-1/4 left-1/4 w-96 h-96 bg-amber-500/10 rounded-full blur-[128px]"></div>
        <div class="absolute bottom-1/4 right-1/4 w-80 h-80 bg-orange-500/10 rounded-full blur-[128px]"></div>
      </div>
      ...
      <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-3xl mx-auto text-center">
          <!-- Badge -->
          <div
            class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-amber-300 text-sm font-semibold mb-8 hero-animate">
          ...
          <h1 class="text-4xl sm:text-5xl md:text-6xl font-black mb-6 leading-tight hero-animate-delay-1">
            ...
            <span
              class="block bg-gradient-to-r from-amber-400 to-orange-500 bg-clip-text text-transparent">
              Những Câu Chuyện Mới
            </span>
          </h1>

          <p class="text-lg text-slate-300/80 max-w-xl mx-auto leading-relaxed mb-10 hero-animate-delay-2">
            Cập nhật những tin tức mới nhất về các cung đường, kinh nghiệm đi phượt và những câu chuyện truyền cảm hứng.
          </p>

          <!-- Category Filters -->
          <div class="flex flex-wrap items-center justify-center gap-3 hero-animate-delay-3">
            <button v-for="category in categories" :key="category.id" @click="selectedCategory = category.id" :class="[
              'group flex items-center gap-2 px-5 py-2.5 rounded-full font-semibold text-sm transition-all duration-300',
              selectedCategory === category.id
                ? 'bg-gradient-to-r from-amber-500 to-orange-500 text-white shadow-lg shadow-amber-500/25'
                : 'bg-white/10 backdrop-blur-md text-white border border-white/10 hover:bg-white/15'
            ]">
              <i :class="['bx', category.icon, 'text-lg']"></i>
