...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300" v-if="post">
        ...
        <div class="flex items-center gap-6">
          <div class="flex items-center gap-4">
            <img :src="post.author.avatar" :alt="post.author.name"
              class="w-14 h-14 rounded-full border-2 border-white/50 shadow-lg" />
            <div>
        ...
        <article class="lg:col-span-8">
          <div
            ...
            <div
              ...
              <img :src="post.author.avatar" :alt="post.author.name"
                class="w-24 h-24 rounded-full border-4 border-white dark:border-gray-600 shadow-md flex-shrink-0" />
              <div>
                <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">{{ post.author.name }}</h3>
                <p class="text-gray-600 dark:text-gray-300 mb-4 leading-relaxed">{{ post.author.bio }}</p>
            ...
            <!-- Comments Section -->
            <div class="mt-16">
              <h3 class="text-2xl font-bold text-gray-800 dark:text-white mb-8">Comments</h3>
              <form class="space-y-6">
                ...
                <textarea placeholder="Your Comment" rows="5"
                  class="w-full px-6 py-4 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-200 dark:focus:ring-orange-500/20 transition-all text-gray-900 dark:text-white placeholder-gray-400"></textarea>
                <button type="submit"
                  class="px-8 py-4 bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold rounded-full hover:shadow-lg hover:shadow-orange-200 dark:hover:shadow-none hover:-translate-y-1 transition-all">
                  Post Comment
                </button>
              </form>
            </div>
          ...
          <div class="sticky top-24 space-y-8">
              ...
              <div class="space-y-6">
                <router-link v-for="relatedPost in relatedPosts" :key="relatedPost.id" :to="`/blog/${relatedPost.id}`"
                  ...
                  <div>
                    ...
                    <span class="text-xs text-gray-500 dark:text-gray-400 font-medium">{{ formatDate(relatedPost.date)
                      }}</span>
                  </div>
                </router-link>
              </div>
            ...
            <div
              ...
              <div class="relative z-10">
                ...
                <p class="text-indigo-100 text-sm mb-6">Get the latest travel tips and stories delivered to your inbox.
                </p>
