...
useHead({
    title: t('customTour.title') || 'Smart Car Tour Builder'
});
</script>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-8 space-y-8">
                    ...
                    <div v-show="activeTab === 'spots'">
                        <div v-if="isLoadingSpots" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div v-for="i in 6" :key="i"
                                class="h-80 bg-zinc-100 dark:bg-zinc-800 animate-pulse rounded-3xl"></div>
                        </div>
                        <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <HotSpotCard v-for="spot in allSpots" :key="spot.id" :spot="spot" :is-locating="isLocating"
                                :isInTrip="isInTrip(spot.id)" @addToTrip="addToTrip" @removeFromTrip="removeFromTrip" />
                        </div>
                    </div>
                ...
                <div class="lg:col-span-4 space-y-6">
                    ...
                    <div
                        ...
                        <h3 class="text-xl font-bold mb-6 dark:text-white flex items-center justify-between">
                            ...
                            <span class="text-xs bg-blue-50 text-blue-600 px-2 py-1 rounded-lg">{{ selectedSpots.length
                                ...
                                <template #item="{ element: spot, index }">
                                    <div
                                        ...
                                        <div class="flex-grow min-w-0">
                                            <h4 class="font-bold text-sm dark:text-white truncate">{{ spot.name }}</h4>
                    ...
                    <div
                        ...
                        <!-- Decorative bg -->
                        <div class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16 blur-3xl">
                        </div>
