...
const filteredTours = computed(() => {
    ...
    if (activeFilters.value.departFrom) {
        result = result.filter(tour =>
            tour.departFrom.toLowerCase().includes(activeFilters.value.departFrom)
        );
    }
        ...
        <div class="container mx-auto px-4 py-12">
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="flex-1">
                    ...
                    <!-- Tours Grid/List -->
                    <div v-if="filteredTours.length > 0" :class="viewMode === 'grid'
                        ? 'grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6'
                        : 'space-y-6'">
                        <div v-for="(tour, index) in filteredTours" :key="tour.id" class="animate-fade-in"
                                            ...
                                            <div>
                                                ...
                                                <div class="space-y-2 mb-4 text-gray-600">
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <span><strong>Khởi hành:</strong> {{ tour.departFrom }}</span>
                                                    </div>
                                                    ...
                                                    <div class="flex items-start gap-2">
                                                        <svg class="w-5 h-5 text-purple-500 mt-0.5" fill="currentColor"
                                                            viewBox="0 0 20 20">
                                                        ...
                                                        <span class="line-clamp-2"><strong>Loại:</strong> {{ tour.type
                                                            }}</span>
                                                    </div>
                                                </div>
                                            </div>
